    ...
    c.fn.extend({remove: function () {
       ...
       // return this.attr("unselectable", "off").css("MozUserSelect", "").unbind("selectstart.ui")
        ...
        if ((c.browser.msie && (/(static|relative)/).test(this.css("position"))) || (/absolute/).test(this.css("position"))) {
            ...
            j = this.parents().filter(function () {
                return(/(auto|scroll)/).test(c(this).css("overflow", 1) + c(this).css("overflow-y", 1) + c(this).css("overflow-x", 1))
            }).eq(0)
        }
...
(function (c) {
    ...
    c.widget("ui.dialog", {_init: function () {
        ...
        if (d) {
            c.each(g, function (h, i) {
                c('<button type="button"></button>').addClass("button").text(h).click(function () {
    ...
    c.extend(c.ui.dialog.overlay, {instances: [], maxZ: 0, events: c.map("focus,mousedown,mouseup,click".split(","),function (d) {
