        ...
        <div id="sp-title" class="col-sm-12 col-md-12">
            <div class="sp-column ">
                <div class="sp-page-title" style="background-image: url(/source/images/demo/about-subheader.jpg);">
                    <div class="container"><h2>Статьи</h2></div>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <article class="item item-page" itemscope="" itemtype="">
                        ...
                        <div class="entry-header">
                            <dl class="article-info">
                                ...
                                <dd class="category-name">
                                    ...
                                    <a href="" itemprop="genre" data-toggle="tooltip" title="" data-original-title="Категория материалов">Статьи</a>	
                                </dd>
                                <dd class="published">
                        ...
                        <ul class="pager pagenav">
                            <?php if (!empty($selectedArts['prev']['id'])) :?>
                                <li class="previous">
                                    <a href="<?php echo \yii\helpers\Url::to(['/main/default/view-article', 'id' => $selectedArts['prev']['id']])?>" rel="prev">
                            ...
                            <?php if (!empty($selectedArts['next']['id'])) :?>
                                <li class="next">
                                    <a href="<?php echo \yii\helpers\Url::to(['/main/default/view-article', 'id' => $selectedArts['next']['id']])?>" rel="next">
